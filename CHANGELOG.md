...
- Adds ability for users to specify base image for etcd pods in a cluster.
  Default base image is `quay.io/benbromhead/cassandra-operator`.
...
Check https://github.com/benbromhead/cassandra-operator/blob/master/doc/user/upgrade/upgrade_guide.md#v02x-to-v03x
...
- TLS feature: user can now create TLS-secured cluster via operator.
  See [TLS guide](https://github.com/benbromhead/cassandra-operator/blob/master/doc/user/cluster_tls.md).
