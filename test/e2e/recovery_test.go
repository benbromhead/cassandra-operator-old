...
//	cl := e2eutil.NewCluster("test-cassandra-", 3)
...
//		t.Fatalf("failed to resize to 3 members cassandra cluster: %v", err)
//	}
//	// TODO: add checking of data in cassandra
//}
//
...
//
//	f := framework.Global
//	clus, err := e2eutil.CreateCluster(t, f.CRClient, f.Namespace, e2eutil.NewCluster("test-cassandra-", 3))
//	if err != nil {
//		t.Fatal(err)
//	}
//	defer func() {
...
//
//	f := framework.Global
//	clus := e2eutil.ClusterWithBackup(e2eutil.NewCluster("test-cassandra-", 3), e2eutil.NewS3BackupPolicy(true))
